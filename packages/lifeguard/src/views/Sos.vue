                ...
                <div class="mt-5 mb-13">
                    <Form @submit.prevent="SendTodo" class="flex flex-col gap-4">
                        <div class="flex flex-col gap-2">
                            ...
                            <input class="bg-dark_grey px-2 py-1 rounded-md w-20" type="number" name="post" id="post"
                                placeholder="0" v-model="todoMessage.post">
                        </div>
                        <div class="flex flex-col gap-2 mt-3">
                            <label for="todoMessage">Wat is je todo voor de hoofdredder?</label>
                            <textarea class="bg-dark_grey px-2 py-1" rows="5" name="todoMessage" id="todoMessage"
                                v-model="todoMessage.description" placeholder="Vul hier je todo in..."></textarea>
                        </div>

                        <button
                            class="bg-greenx rounded-full text-white font-bold py-2 cursor-pointer hover:bg-dark_green transition-all">Verstuur
                            todo</button>
                    </Form>
                </div>
            </div>
