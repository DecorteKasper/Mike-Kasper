...
<!-- Form -->
    ...
    <!-- Oefeningen uitgevoerd of gesport? -->
            ...
            <div v-else>
                <p class="mt-10 text-center text-base">Het verslag voor vandaag is ingediend</p>
                 <img class="max-w-[5rem] m-auto mt-4" src="@/assets/icons/checkReport.svg" alt="Submitted Icon" />
            </div>
    ...
    setup() {
        ...
        if (reportsResult.value && reportsResult.value.reports) {
            ...
            if (todayReports.value?.length === 0) {
                console.log("Dagverslag is nog niet ingediend");
                reportInfo.value = false;
            } else {
                console.log("Dagverslag is ingediend");
